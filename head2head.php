...
if ($fromGF == 'true') {
$type = 'Head2Head';
startGame($userOne, $userTwo, $type, $db);
var_dump(h2hGameExists($db, $userOne, $userTwo));    
if (h2hGameExists($db, $userOne, $userTwo)) {    
loadh2hGame ($userOne, $userTwo, $db);
} else  { createh2hGame($userOne, $userTwo, $db); }
}    
?>
...
<!--
<script type="text/javascript" src="js/h2h.js"></script>
-->
<script type="text/javascript">
var oldURL = '<?php echo $pageInput; ?>';
var fromGF = '<?php echo $fromGF; ?>';
var userLogin = '<?php if (isset($_SESSION['username'])) { echo $_SESSION['username']; } ?>'; 
var userOne = '<?php echo $userOne; ?>';
var userTwo = '<?php echo $userTwo; ?>';
var firstVisit = '<?php echo $firstVisit; ?>';
console.log('PageLoad firstVisit: ' + firstVisit);    
var userId = <?php if ($userOne !== '') { echo getUserID($db, $userOne); } else { echo 0; } ?>;
var friendId = <?php if ($userTwo !== '') { echo getUserID($db, $userTwo); } else { echo 0; } ?>;
    
document.addEventListener("DOMContentLoaded", function () {  
if (oldURL == 'messageFriend.php') { sendMsg(user, friend); }
if (fromGF == 'false') { console.log('fromGF = False\nYou need to accept game invite to play'); } 
});
</script>     
</head>
<body>
...
<div class="p2score">Score: <span id="p2score">0</span></div>
<div class="p2progress">
<div class="P2BarCont">
<span class="BarName">
<img class="barProfileImg" id="barProfileImg" src="img/profileImg.jpg">
<span class="BarNameSpan" id="BarP2Name">
Pholder
</span>  
<span class="NameProg" id="BarP2Prog"> 0</span><span>%</span>     
</span>
<div class="P2ProgressBar" Id="P2Progress"></div>
</div>
</div> 
<div class="p2WPM">WPM: <span id="p2WPM">0</span></div>
</div> <!-- P2 progress end -->    
</div>
